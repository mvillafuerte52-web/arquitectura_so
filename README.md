...
> lo que vimos en la anterior clase
...
code . #Abrimos VSC para editar el archivo.<br>
...
[Profesor Ariel Betancud] ![alt text](image.png)
...
![GitBashImage](image-1.png)

¿Qué es Gitflow? Gitflow es un modelo alternativo de creación de ramas en Git en el que se utilizan ramas de función y varias ramas principales. Fue Vincent Driessen en nvie quien lo publicó por primera vez y quien lo popularizó.<br>
...
Funcionamiento de Git merge<br>
...
Cómo funcionan las llaves públicas y privadas<br>
